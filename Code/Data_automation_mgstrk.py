...
class Home_seeker:
    ...
    dee.detailed_data_from_offer(self):
        ...
        headers_table = [additional_rent, deposit, surface, rooms]
        ...
        offer_details_list = []
        self.driver.get('https://www.otodom.pl/oferta/florianska-centrum-stare-miasto-klimatyzacja-ciche-ID43Gy7.html#a9774d3f7a')
        ...
        headers = ['additional_rent', 'deposit', 'surface', 'rooms']
        pd.DataFrame({'additional_rent':headers_table[0],'deposit':headers_table[1], 'surface':headers_table[2], 'rooms':headers_table[3]}).to_csv('your.csv')
